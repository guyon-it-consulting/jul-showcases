...
| [`qa-browser/`](qa-browser/) | QA from the ticket | The PO writes the acceptance test in plain French; JuL alone runs it in a real browser and checks each criterion. `--replay` reruns it for $0. | `Choice` + `Noul` |
